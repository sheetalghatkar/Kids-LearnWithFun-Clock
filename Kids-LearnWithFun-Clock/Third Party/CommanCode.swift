...
//    static let Clock_Digit_Color = UIColor(red: (239/255), green: (134/255), blue: (208/255), alpha: 1.0)  //Pink
    ...
    //------------------------------------------------------------------------
    static var hourAngleRangeArray: [[Double]] = [[3.12,2.60],[2.60,2.07],[2.07,1.56],[1.56,1.05],[1.05,0.55],[0.55,-0.02],[-0.02,-0.56],[-0.56,-1.04],[-1.04,-1.60],[-1.60,-2.10],[-2.10,-2.60],[-2.60,-3.12]]
    //------------------------------------------------------------------------
    ...
    static var minuteCalculationArray = [[3.13,1.57],[1.48,0.00],[-0.10,1.58],[1.68,-3.05]]
    //------------------------------------------------------------------------
