...
//    static let CLOCK_RED_TICK_Color = UIColor.black
 ...
 //   static var minuteQuarterDiffArray = [[3.14,1.05],[1.06,-1.04],[-1.05,-3.13]]
    ...
    //------------------------------------------------------------------------
//    static var hourAngleRangeArray: [[Double]] = [[3.14,2.59],[2.60,2.06],[2.07,1.55],[1.56,1.04],[1.05,0.54],[0.55,-0.01],[-0.02,-0.55],[-0.56,-1.03],[-1.04,-1.59],[-1.60,-2.09],[-2.10,-2.59],[-2.60,-3.13]]
    //------------------------------------------------------------------------
    static var hourCalculationArray = [[3.14,3.00,2.86,2.73,2.61],[2.60,2.46,2.33,2.20,2.08], [2.07,1.94,1.81,1.68,1.57],[1.56,1.43,1.30,1.17,1.06],[1.05,0.92,0.80, 0.67,0.56], [0.55,0.40,0.26,0.12,-0.01],[-0.02,-0.15,-0.29,-0.42,-0.55], [-0.56,-0.68,-0.80,-0.92,-1.03], [-1.04,-1.18,-1.32,-1.46,-1.59],[-1.60,-1.72,-1.85,-1.97,-2.09],[-2.10,-2.22,-2.35,-2.47,-2.59], [-2.60,-2.73,-2.86,-2.99,-3.13]]
...
//    static let arr2 = Array(0...guessTimeArray.count)
  ...
  //  static var imgSoundOff = UIImage(named: "Sound-Off.png")
    ...
    static var CLOCKET_WIDTH_PERCENT_PLAY = UIDevice.current.userInterfaceIdiom == .pad ? ((UIScreen.main.bounds.height > 1100) ? CGFloat(0.6) : CGFloat(0.55)) :((UIScreen.main.bounds.height < 670) ? CGFloat(0.70) : CGFloat(0.75))
